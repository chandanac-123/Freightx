export default function AboutSub() {
  return (
    <div className="grid container max-w-screen-4k gap-x-20 gap-y-10 px-6 py-16 md:px-12 xl:px-12 xl:py-16">
      <div>
        ...
        <div className="w-full">
          ...
          <h6 className="text-black mt-2 font-inter">
            ...
            and always feels secure in their partnership with us.
          </h6>
        </div>
      </div>
    </div>
